...
def show():
           mysqldb = mysql.connector.connect(host = "localhost", user = "root",passwd = "manager",database="pythonDB3")
...
def Add():
    ...
    mobile = e3.get()
    salary = e4.get()
    mysqldb=mysql.connector.connect(host="localhost",user="root",password="manager",database="pythonDB3")
    mycursor=mysqldb.cursor()
    try:
